...
include 'includes/connect.php';
	...
	if($_SESSION['seller_sid']==session_id())
	{
		?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Drink Menu</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM orders WHERE shopid = '{$_SESSION['user_id']}'");
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
								...
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM tickets WHERE shopid = '{$_SESSION['user_id']}'");
									while($row = mysqli_fetch_array($sql)){
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Drink Menu</h5>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items WHERE shopid = '{$_SESSION['user_id']}'");
				while($row = mysqli_fetch_array($result))
				{
					echo '<tr><td><img src="images/items/'.$row['image'].'" width="40"></td>
          <td><div class="input-field col s12"><label for="'.$row["id"].'_name">Name</label>';
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="image">Item Image</th>
                      </tr>
                    </thead>
				...
				<?php
					...
					// echo '<td><div class="input-field col s12"><label for="itemImage">Item Image</label><br/>';
          echo '<td><input id="itemImage" name="itemImage" type="file" required></td>';                                 
					echo '<td></tr>';
				?>
                    </tbody>
</table>
      ...
      itemImage:{
		...
		name: {
		 ...
		 price: {
				...
				minlength: "Minimum item price is Euro 1"
			},
	},
		errorElement : 'div',
        errorPlacement: function(error, element) {
