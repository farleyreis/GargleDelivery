        ...
        <div class="wrapper">
          ...
          <aside id="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Drink</a>
                </li>
                    <li class="no-padding">
            ...
            <div class="container">
              ...
              <div class="divider"></div>
                                    ...
                                    <?php
                                        ...
                                        $sql = mysqli_query($con, "SELECT * FROM tickets WHERE status LIKE '$status' AND  shopid = '{$_SESSION['user_id']}'");
                                        while($row = mysqli_fetch_array($sql)){                                                             
                                        echo'<a href="view-ticket-admin.php?id='.$row['id'].'"class="collection-item">
                                            <div class="row">
                                                <div class="col s6">
