...
CREATE TABLE `orders` (
  ...
  `delivery_fee` varchar(10) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `role`, `name`, `username`, `password`, `email`, `address`, `latitude`, `longitude`, `contact`, `image`, `logo`, `token`, `verified`, `deleted`) VALUES
(1, 'Administrator', 'Admin 1', 'root', '$2y$10$9C7l3dZQq1SefGCa7YG5/Og4/JSA9WgmwR1tTwtyUGKaSM23KAxfi', '', 'Address 1', '', '', 9898000000, NULL, NULL, '', 1, 0);
