...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    ...
    <div class="col s12 center">
      ...
      <form class="registerSellerForm" id="registerSellerForm" method="post" novalidate="novalidate" action="routers/register-router-seller.php" enctype="multipart/form-data" class="col s12">
        <div class="row">
          <div class="input-field col s12 center">
            <h4>Become a partner</h4>
            <p class="center">Join as a seller!</p>
          </div>
        </div>
        ...
        <div class="row margin">
          <div class="input-field col s12">
            <p>Shop Logo</p>
            <input name="storeLogo" id="storeLogo" type="file" required>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
            <p >Please verify your store by uploading legal Photo</p>
            <input name="storeLegal" id="storeLegal" type="file" required>
          </div>
        </div>
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        $("form#registerSellerForm").validate({
          rules: {
            username: {
                required: true,
                minlength: 5
