        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="seller-page.php" class="brand-logo darken-1"><img src="images/materialize-logo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>				
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="seller-page.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Drink</a>
            </li>
                <li class="no-padding">
...
<div>
                ...
                <?php if($role=='Customer' && !empty($image)){ ?>
                <div class="row">
                        <div class="input-field col s12">
                        <p>ID Legal Photo:</p><a target="_blank" href="images/ids/<?php echo $image; ?>"><img src="images/ids/<?php echo $image; ?>" width="100"></a>
                        </div>
                      </div>  
                <?php }elseif($role=='Seller' && !empty($image)){ ?>
                <div class="row">
                        <div class="input-field col s12">
                          <p>Store Legal Photo:</p><a target="_blank" href="images/store/legal/<?php echo $image; ?>"><img src="images/store/legal/<?php echo $image; ?>" width="100"></a>
                        </div>
                        <div class="input-field col s12">
                        <p>Store Logo Photo:</p><a target="_blank" href="images/store/logo/<?php echo $logo; ?>"><img src="images/store/logo/<?php echo $logo; ?>" width="100"></a>
                        </div>
                      </div>
                      <?php } ?> 
                      <br/>
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/update-user-router.php" novalidate="novalidate"class="col s12">
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Gargle Delivery <a class="grey-text text-lighten-4" href="#" target="_blank">Students</a> All rights reserved.</span>
...
<?php
	}elseif( isset($_SESSION['seller_sid']))
  {
    ?>
<!DOCTYPE html>
<html lang="en">
