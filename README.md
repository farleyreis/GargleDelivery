...
1. Create Database Drink.
2. Run Drink.sql script provided in sql folder.
...
6. What's lacking? Dynamic payment(real payment system) and error reporting lacks in this project. And also one might wish for showing corresponding Drink item's photo and all that stuff.
