    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Drink Menu</a>
            </li>
                <li class="no-padding">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="seller-page.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Drink Menu</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
...
<div id="work-collections" class="seaction">
                    ...
                    $sql = mysqli_query($con, "SELECT * FROM orders WHERE status LIKE '$status' AND shopid = '{$_SESSION['user_id']}'");
                    if($sql){
                    echo '<div class="row">
                <div>
                    <h4 class="header">List</h4>
